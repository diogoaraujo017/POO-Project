...
public class Info_Inicial {
    ...
    m4 = new Malas("Mala de mão", "Rimowa", "gdsa4", 487.46, 'c', 3, "TNT", 83, 38, 55, "PVC", 2015, true);
    ...
    m8 = new Malas("Mala executiva", "Tumi", "gsad123", 513.25, 'n', 3, "TNT", 82, 45, 10, "Couro", 1963, true);
    ...
    m12 = new Malas("Mala executiva", "Tumi", "dashdas1", 833.13, 'c', 6, "TNT", 48, 44, 54, "Couro", 2010, true);
    ...
    m15 = new Malas("Mala grande", "Delsey", "asdhj7", 273.01, 'c', 4, "TNT", 107, 55, 36, "Poliéster", 2022, true);
